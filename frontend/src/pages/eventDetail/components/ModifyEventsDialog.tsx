        ...
        return (
            <Dialog open onClose={handleClose} maxWidth="sm" fullWidth>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleEditSave} variant="contained" loading={isUpdating}>
                        Save
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog open onClose={handleClose}>
                ...
                <DialogContent>
                    <Typography>
                        ...
                        This action cannot be undone. All attendees and attendance
                ...
                <DialogActions>
                    ...
                    <Button onClick={onDelete} variant="contained" color="error" loading={isDeleting}>
                        Delete
                    </Button>
                </DialogActions>
            </Dialog>
        ...
        <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
            ...
            <List>
                ...
                <ListItemButton onClick={() => setView('delete')}>
                    ...
                    <ListItemText primary="Delete event" slotProps={{primary: {sx: {color: 'error.main'}}}}/>
                </ListItemButton>
            </List>
        </Dialog>
    )
